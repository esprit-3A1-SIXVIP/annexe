...
ALTER TABLE `participation`
  ...
  ALTER TABLE `participation`
  ADD CONSTRAINT `fk_paticipevent` FOREIGN KEY (`evenementId`) REFERENCES `evenement` (`evenementId`);
...
--
ALTER TABLE `commentaire`
  ADD CONSTRAINT `fk_commentaireuserId` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`);
  ALTER TABLE `commentaire`
  ADD CONSTRAINT `fk_commentairequestionId` FOREIGN KEY (`questionId`) REFERENCES `question` (`questionId`);
...
--
ALTER TABLE `utilisationrefuge`
  ADD CONSTRAINT `fk_utilisadonId` FOREIGN KEY (`donId`) REFERENCES `don` (`donId`);
ALTER TABLE `utilisationrefuge`
  ADD CONSTRAINT `fk_utilisabId` FOREIGN KEY (`beneficiaireId`) REFERENCES `beneficiaire` (`beneficiaireId`);
